...
class BIORBD_API GeneralizedVelocity : public utils::Vector {
 public:
  ...
  ///
  GeneralizedVelocity(size_t nbQdot);
  ...
  ///
  GeneralizedVelocity(const GeneralizedVelocity& Q);
  ...
  GeneralizedVelocity(const Eigen::MatrixBase<OtherDerived>& other)
      : utils::Vector(other) {}
#endif
  ...
  /// \param v The vector to copy
  ///
  GeneralizedVelocity(const casadi::MX& v);
