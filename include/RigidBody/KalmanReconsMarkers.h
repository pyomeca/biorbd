...
class BIORBD_API KalmanReconsMarkers : public KalmanRecons {
 public:
  ...
  ///
  /// \brief Initialize the Kalman filter and Kalman reconstruction for Markers
  /// data
  ///
  KalmanReconsMarkers();
  ...
  ///
  KalmanReconsMarkers(Model &model, KalmanParam params = KalmanParam());
  ...
  /// \param removeAxes If the algo should ignore or not the removeAxis defined
  /// in the bioMod file
  ///
