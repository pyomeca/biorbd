...
class BIORBD_API GeneralizedTorque : public utils::Vector {
 public:
  ...
  ///
  GeneralizedTorque(size_t nTorque);
  ...
  ///
  GeneralizedTorque(const GeneralizedTorque& other);
  ...
  GeneralizedTorque(const Eigen::MatrixBase<OtherDerived>& other)
      : utils::Vector(other) {}
  ...
  /// \param v The vector to copy
  ///
  GeneralizedTorque(const casadi::MX& v);
  ...
  ///
  template <typename OtherDerived>
  GeneralizedTorque& operator=(const Eigen::MatrixBase<OtherDerived>& other) {
