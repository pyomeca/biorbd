...
class BIORBD_API Markers {
 public:
  ...
  ///
  /// \brief Change the values of a specific marker without changing other
  /// parameters
  /// \param index The index of the marker to change. If biorbd is compiled with
  /// SKIP_ASSERT, then no check is performed to ensure index is within bounds
  /// \param pos The new position of the marker
  ///
  void setMarker(size_t index, const NodeSegment &pos);
  ...
  ///
  const NodeSegment &marker(size_t idx) const;

  ///
  /// \brief Return a marker of index idx in the marker set with the axes
  /// removed
  /// \param idx The index of the marker
  /// \return The marker of index idx
  ///
  NodeSegment markerAxesRemoved(size_t idx) const;

  ///
  /// \brief Compute and return the position of a marker at given Q in the
  ...
  ///
  /// \brief Compute and return the position of the marker of index idx at given
  /// Q in the global reference frame
  /// \param updatedModel The joint model updated to the proper kinematics level
  /// \param Q The generalized coordinates
  ...
  ///
  /// \brief Return a copy of all the markers in their respective parent
  /// reference frame
  /// \param removeAxis If there are axis to remove from the position variables
  /// \return All the markers
  ///
  std::vector<NodeSegment> markers(bool removeAxis = true) const;
  ...
  ///
  /// \brief Return all the technical markers at a given Q in the global
  /// reference frame
  /// \param updatedModel The joint model updated to the proper kinematics level
  /// \param Q The generalized coordinates
  /// \param removeAxis If there are axis to remove from the position variables
  ...
  ///
  /// \brief Return the technical markers in their respective parent reference
  /// frame
  /// \return A vector of all the technical markers in their parent reference
  /// frame
  ///
  ...
  ///
  /// \brief Return all the anatomical markers at a given Q in the global
  /// reference frame
  /// \param updatedModel The joint model updated to the proper kinematics level
  /// \param Q The generalized coordinates
  /// \param removeAxis If there are axis to remove from the position variables
  ...
  ///
  /// \brief Return the anatomical markers in their respective parent reference
  /// frame
  /// \return A vector of all the anatomical markers in their parent reference
  /// frame
  ///
  ...
  ///
  /// \brief Return all the markers of the segment idx at a given Q in the
  /// global reference frame
  /// \param updatedModel The joint model updated to the proper kinematics level
  /// \param Q The generalized coordinates
  ...
  ///
  size_t nbMarkers(size_t idxSegment) const;
