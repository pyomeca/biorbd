...
class BIORBD_API Ligaments {
 public:
  ...
  ///
  void DeepCopy(const Ligaments& other);
  ...
  ///
  /// \brief ligamentNames Return the names for all the ligament ordered by
  ...
  /// i.e. \f$-J \times F\f$
  ///
  /// where \f$J\f$ is the ligament lengths jacobian and \f$F\f$ is the force
  /// vector of all the ligaments
  ///
  /// Warning: This function assumes that ligaments are already updated (via
  /// `updateligaments`)
  ///
  rigidbody::GeneralizedTorque ligamentsJointTorque(const utils::Vector& F);
  ...
  /// \param updateLigamentKinematics If the ligament kinematics parameters
  /// should be updated
  ///
  ...
  /// \param Q The generalized coordinates
  /// \param Qdot The generalized velocities
  /// \param updateKin If the kinematics should be updated (0 => no update
  /// required, 1 => Only ligament parameters, 2 => Joints model and ligaments)
  ///
  /// This function updates the ligaments and then performs the computation for
  /// the ligament joint torque is done from virtual power:
  ///
  ...
  /// \param updatedModel The joint model updated to the proper kinematics level
  /// \param Q The generalized coordinates
  /// \param updateLigamentKinematics If the kinematics parameters of the
  /// ligaments should be updated
  ...
  ///
  /// \brief Update by hand all the ligaments (positions, jacobian, velocity,
  /// etc.)
  /// \param updatedModel The joint model updated to the proper kinematics level
  /// \param ligamentPointsInGlobal The ligament points in global reference
  /// frame
