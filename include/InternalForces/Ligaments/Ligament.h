...
class BIORBD_API Ligament : public Compound {
 ...
 public:
  ...
  ///
  Ligament(const Ligament& other);

  ///
  /// \brief Construct a ligament from another ligament
  /// \param other The other ligament
  ///
  Ligament(const std::shared_ptr<Ligament> other);
  ...
  ///
  void DeepCopy(const Ligament& other);
  ...
  /// \param updateLigamentKinematics If the kinematic parameters of the
  /// ligament should be updated
  ...
  ///
  /// \brief Update the position of the origin and insertion positions of the
  /// ligament
  /// \param updatedModel The joint model updated to the proper kinematic level
  /// \param Q The generalized coordinates
  ///
  ...
  ///
  /// \brief Update the position of the origin and insertion nodes of the
  /// ligament
  /// \param updatedModel The joint model updated to the proper kinematic level
  /// \param Q The generalized coordinates
  /// \param Qdot The generalized velocities
  ...
  ///
  /// \brief Update by hand the position of the origin and insertion nodes of
  /// the ligament
  ...
  ///
  /// \brief Set the position of all the points attached to the ligament (0
  /// being the origin)
  /// \param positions New value of the position
  ///
  void setPosition(const internal_forces::Geometry& positions);

  ///
  /// \brief Return the position of all the points attached to the ligament (0
  /// being the origin)
  ...
  ///
  void setCharacteristics(const LigamentCharacteristics& characteristics);
  ...
  ///
  /// \brief Return the previously computed ligament points in global reference
  /// frame
  /// \return The ligament points in global reference frame
  ///
  ...
  ///
  /// \brief Return the computed force norm. The ligament orientation had to be
 ...
 protected:
  ...
  std::shared_ptr<internal_forces::Geometry>
      m_position;  ///< The position of all the nodes of the ligament (0 being
                   ///< the origin and last being insertion
  std::shared_ptr<LIGAMENT_TYPE> m_type;  ///< The type of the ligament
  std::shared_ptr<LigamentCharacteristics>
      m_characteristics;                     ///< The ligament characteristics
