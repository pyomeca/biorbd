...
///
/// \brief Class compound is a very generic definition of what a muscle is. It
/// should be the base class of every muscles
///
class BIORBD_API Compound {
 public:
  ...
  ///
  Compound(const utils::String& name);
  ...
  /// \param other The muscle to shallow copy
  ///
  Compound(const std::shared_ptr<Compound> other);
  ...
  ///
  void DeepCopy(const Compound& other);
  ...
  ///
  const internal_forces::PathModifiers& pathModifier();
