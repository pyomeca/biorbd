...
///
/// \brief Class PassiveTorqueLinear is a joint passive torque type that
/// linearly evolves Linear passive torque define by : mx+b
class BIORBD_API PassiveTorqueLinear : public PassiveTorque {
 public:
  ...
  ///
  PassiveTorqueLinear(const PassiveTorqueLinear& other);
  ...
  ///
  void DeepCopy(const PassiveTorqueLinear& other);
