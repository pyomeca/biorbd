...
///
/// \brief Class PassiveTorqueConstant is a joint passive torque type which
/// maximum is contant
///
class BIORBD_API PassiveTorqueConstant : public PassiveTorque {
 public:
  ...
  ///
  PassiveTorqueConstant(const PassiveTorqueConstant& other);
  ...
  ///
  PassiveTorqueConstant(const utils::Scalar& Torque, size_t dofIdx);
  ...
  ///
  /// \brief Deep copy of the constant passive torque to another constant
  /// passive torque
  /// \param other The constant passive torque to copy
  ///
  void DeepCopy(const PassiveTorqueConstant& other);
