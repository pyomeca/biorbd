...
class BIORBD_API PassiveTorques {
 public:
  ...
  ///
  PassiveTorques(const PassiveTorques& other);
  ...
  ///
  /// \brief Deep copy of the passive torque holder from other passive torque
  /// holder
  /// \param other The other passive torques
  ///
  void DeepCopy(const PassiveTorques& other);

  ///
  /// \brief Add a passive torque to the set of passive torques
  /// \param other The passive torque to add
  ///
  void addPassiveTorque(const PassiveTorque& other);
 ...
 protected:
  std::shared_ptr<std::vector<
      std::shared_ptr<internal_forces::passive_torques::PassiveTorque>>>
      m_pas;                                      ///< Passive torque to add
