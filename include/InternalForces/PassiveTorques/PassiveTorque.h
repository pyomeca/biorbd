...
class BIORBD_API PassiveTorque {
 public:
  ...
  ///
  PassiveTorque(const PassiveTorque& other);

  ///
  /// \brief Construct passive torque from another passive torque
  /// \param other The other passive torque
  ///
  PassiveTorque(const std::shared_ptr<PassiveTorque> other);

  ///
  /// \brief Construct passive torque
  /// \param dofIdx Index of the DoF associated with passive torque
  ///
  PassiveTorque(size_t dofIdx);
  ...
  ///
  PassiveTorque(size_t dofIdx, const utils::String& jointName);
  ...
  ///
  void DeepCopy(const PassiveTorque& other);
