...
class BIORBD_API ActuatorSigmoidGauss3p : public Actuator {
 public:
  ...
  ///
  /// \brief Construct SigmoidGauss3p actuator from another SigmoidGauss3p
  /// actuator
  /// \param other The other SigmoidGauss3p actuator to copy
  ///
  ActuatorSigmoidGauss3p(const ActuatorSigmoidGauss3p& other);
  ...
  ///
  /// \brief Deep copy of the SigmoidGauss3p actuator from another
  /// SigmoidGauss3p actuator
  /// \param other The SigmoidGauss3p actuator to copy
  ///
  void DeepCopy(const ActuatorSigmoidGauss3p& other);
 ...
 protected:
  ...
  std::shared_ptr<utils::Scalar> m_theta;   ///< Amplitude of the Sigmoid
  std::shared_ptr<utils::Scalar> m_lambda;  ///< Tilt factor of the Sigmoid
