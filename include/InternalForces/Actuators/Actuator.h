...
class BIORBD_API Actuator {
 public:
  ...
  ///
  Actuator(int direction, size_t dofIdx);
  ...
  ///
  Actuator(int direction, size_t dofIdx, const utils::String& jointName);
  ...
  ///
  void DeepCopy(const Actuator& other);
 ...
 protected:
  ...
  std::shared_ptr<int>
      m_direction;  ///< The direction of the actuator (+1 or -1)
