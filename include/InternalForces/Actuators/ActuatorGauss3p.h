...
class BIORBD_API ActuatorGauss3p : public Actuator {
 public:
  ...
  ///
  ActuatorGauss3p(const ActuatorGauss3p& other);
  ...
  ///
  void DeepCopy(const ActuatorGauss3p& other);
 ...
 protected:
  ...
  std::shared_ptr<utils::Scalar> m_wr;    ///< 1/10 de la distance amax/amin
  std::shared_ptr<utils::Scalar> m_w1;    ///< Mid point plateau

  // Torque/angle relationship
  std::shared_ptr<utils::Scalar> m_r;     ///< Width of the gaussian curve
