...
///
/// \brief Implementation of Xia
/// (https://www.sciencedirect.com/science/article/pii/S0021929008003692)
/// dynamic fatigue model
///
class BIORBD_API FatigueDynamicStateXia : public FatigueDynamicState {
 public:
  ///
  ...
  ///
  FatigueDynamicStateXia(const std::shared_ptr<FatigueState> other);
  ...
  ///
  void DeepCopy(const FatigueDynamicStateXia& other);
