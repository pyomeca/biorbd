...
class BIORBD_API FatigueParameters {
 public:
  ...
  ///
  void DeepCopy(const FatigueParameters& other);

  ///
  /// \brief Set the fatigue rate
  /// \param fatigueRate The fatigue rate
  ///
  void setFatigueRate(const utils::Scalar& fatigueRate);
  ...
  /// \param recoveryRate The recovery rate
  ///
  void setRecoveryRate(const utils::Scalar& recoveryRate);
  ...
  /// \param developFactor The develop factor
  ///
  void setDevelopFactor(const utils::Scalar& developFactor);
  ...
  /// \param recoveryFactor The recovery factor
  ///
  void setRecoveryFactor(const utils::Scalar& recoveryFactor);
