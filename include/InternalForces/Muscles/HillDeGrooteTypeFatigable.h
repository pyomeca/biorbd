...
/// Note that useful defaults values for the FatigueParameters characteristics
/// are: fatigueRate = 0.01 recoveryRate = 0.002 developFactor = 10
/// recoverFactor = 10
///
class BIORBD_API HillDeGrooteTypeFatigable : public HillDeGrooteType,
                                             public FatigueModel {
 public:
  ///
  ...
  ///
  HillDeGrooteTypeFatigable(const Muscle& other);

  ///
  /// \brief Construct a Hill-DeGroote-type muscle from another muscle
  /// \param other The other muscle (pointer)
  ///
  HillDeGrooteTypeFatigable(const std::shared_ptr<Muscle> other);
  ...
  ///
  /// \brief Deep copy of a Hill-DeGroote-type fatigable muscle in a new
  /// Hill-DeGroote-type fatigable muscle
