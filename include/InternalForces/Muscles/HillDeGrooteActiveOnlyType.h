...
///
class BIORBD_API HillDeGrooteActiveOnlyType : public HillDeGrooteType {
 public:
  ///
  ...
  ///
  HillDeGrooteActiveOnlyType(const Muscle& other);

  ///
  /// \brief Construct a Hill-DeGroote-type muscle from another muscle
  /// \param other The other muscle (pointer)
  ///
  HillDeGrooteActiveOnlyType(const std::shared_ptr<Muscle> other);
  ...
  ///
  /// \brief Deep copy of a Hill-DeGroote-type muscle in a new
  /// Hill-DeGroote-type muscle
