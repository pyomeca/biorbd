...
class BIORBD_API StateDynamics : public State {
 public:
  ...
  ///
  StateDynamics(const State& other);
  ...
  ///
  void DeepCopy(const StateDynamics& other);
  ...
  ///
  /// \brief Compute and return the activation time derivative from the
 ...
 protected:
  ...
  std::shared_ptr<utils::Scalar> m_activationDot;  ///< The activation velocity
};
