...
///
/// \brief A muscle group is muscle that share parents for both origin and
/// insertion
///
class BIORBD_API MuscleGroup {
 public:
  ...
  ///
  MuscleGroup(const MuscleGroup& other);
  ...
  ///
  void DeepCopy(const MuscleGroup& other);
  ...
  virtual void addMuscle(
      ...
      STATE_TYPE stateType = STATE_TYPE::NO_STATE_TYPE,
  ...
  ///
  virtual void addMuscle(const Muscle& muscle);
  ...
  /// \return The muscle of a specific index
  ///
  const Muscle& muscle(size_t idx) const;
  ...
  ///
  int muscleID(const utils::String& name);
  ...
  ///
  void setOrigin(const utils::String& name);
  ...
  ///
  void setInsertion(const utils::String& name);
