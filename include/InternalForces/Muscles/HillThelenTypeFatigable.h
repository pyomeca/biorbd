...
/// recoverFactor = 10
///
class BIORBD_API HillThelenTypeFatigable : public HillThelenType,
                                           public FatigueModel {
 public:
  ///
  ...
  ///
  HillThelenTypeFatigable(const Muscle& other);

  ///
  /// \brief Construct a Hill-Thelen-type muscle from another muscle
  /// \param other The other muscle (pointer)
  ///
  HillThelenTypeFatigable(const std::shared_ptr<Muscle> other);
  ...
  ///
  /// \brief Deep copy of a Hill-Thelen-type fatigable muscle in a new
