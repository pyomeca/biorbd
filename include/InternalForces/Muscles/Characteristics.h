...
class BIORBD_API Characteristics {
 public:
  ...
  ///
  void DeepCopy(const Characteristics& other);

  ///
  /// \brief Set the length without tension
  /// \param val Value of the length without tension
  ///
  void setOptimalLength(const utils::Scalar& val);
  ...
  ///
  virtual void setForceIsoMax(const utils::Scalar& val);
  ...
  ///
  void setTendonSlackLength(const utils::Scalar& val);
  ///
  ...
  ///
  void setPennationAngle(const utils::Scalar& val);
  ///
  ...
  ///
  void setPCSA(const utils::Scalar& val);
  ...
  ///
  void setMinActivation(const utils::Scalar& val);
  ...
  ///
  void setTorqueActivation(const utils::Scalar& val);
  ...
  ///
  void setTorqueDeactivation(const utils::Scalar& val);
  ...
  ///
  void setStateMax(const State& emgMax);
  ...
  ///
  void setFatigueParameters(const FatigueParameters& fatigueParameters);
  ///
 ...
 protected:
  ...
  std::shared_ptr<bool>
      m_useDamping;  ///< Use damping for muscle force from activation
  std::shared_ptr<State>
      m_stateMax;  ///< Maximal excitation et activation of the muscle

  std::shared_ptr<utils::Scalar>
      m_maxShorteningSpeed;  ///< Maximal velocity of shortening
