...
class BIORBD_API Reader {
 public:
  ...
  ///
  static Model readModelFile(const utils::Path &path);
  ...
  ///
  static void readModelFile(const utils::Path &path, Model *model);
  ...
  ///
  static std::vector<utils::Vector> readTorqueDataFile(const utils::Path &path);
  ...
  ///
  static std::vector<std::vector<utils::SpatialVector>> readViconForceFile(
  ...
  ///
  static rigidbody::Mesh readMeshFileBiorbdSegments(const utils::Path &path);
  ...
  /// \return Returns the mesh
  ///
  static rigidbody::Mesh readMeshFilePly(const utils::Path &path);
  ...
  /// \return Returns the mesh
  ///
  static rigidbody::Mesh readMeshFileObj(const utils::Path &path);
  ...
  /// \return Returns the mesh
  ///
  static rigidbody::Mesh readMeshFileVtp(const utils::Path &path);
#endif
  ...
  /// \return Returns the mesh
  ///
  static rigidbody::Mesh readMeshFileStl(const utils::Path &path);
 ...
 protected:
  ...
  ///
  /// \brief Read a RT matrix either in 4x4 format or Rot1233 seq Trans123
  /// format
  /// \param file A reference to the current file being read pointing to the RT
  /// \param variable The variable set
