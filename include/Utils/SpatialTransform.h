...
#else
class BIORBD_API SpatialTransform
    : public RigidBodyDynamics::Math::SpatialTransform
#endif
{
 public:
  ///
  ...
  ///
  SpatialTransform(const RotoTrans& rototrans);
  ...
  /// \param other The SpatialTransform to copy
  ///
  SpatialTransform(const RigidBodyDynamics::Math::SpatialTransform& other);

  ///
  /// \brief operator= For submatrices
  /// \param other The SpatialTransform to copy
  ///
  void operator=(const SpatialTransform& other);
#endif
