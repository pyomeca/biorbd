...
#endif
{
 public:
  ...
  ///
  /// Code adapted from
  /// https://github.com/brainexcerpts/3x3_polar_decomposition/blob/master/src/polar_decomposition_3x3.inl
  ///
  utils::Matrix3d orthoNormalize() const;
#endif

  ///
  /// \brief Creates a base 3d matrix from a euler sequence of exactly 3
  /// elements
  ...
  ///
  Matrix3d(const RBDLCasadiMath::MX_Xd_static<3, 3>& other);

  ///
  /// \brief Construct matrix from Casadi matrix
  /// \param other The matrix to copy
  ///
  Matrix3d(const RBDLCasadiMath::MX_Xd_SubMatrix& other);
