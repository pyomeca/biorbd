...
#endif
{
 public:
  ...
  ///
  Quaternion(const Scalar& kStabilizer = 1);
  ...
  /// \param kStab The value of the kstabilizer
  ///
  static Quaternion fromMatrix(const RotoTrans& rt, const Scalar& kStab = 1);
  ...
  /// \param kStab The value of the kstabilizer
  ///
  static Quaternion fromMatrix(const Rotation& mat, const Scalar& kStab = 1);

  ///
  /// \brief Construct Quaternion from Euler angles (sequece ZYX)
  /// \param zyx_angles The Euler angles in a sequence where the first element
  /// is the Z-component
  /// \param kStab The value of the kstabilizer
  ///
  ...
  /// \param yxz_angles The Euler angles in a sequence where the first element
  /// is the Y-component
  /// \param kStab The value of the kstabilizer
  ///
  ...
  /// \param xyz_angles The Euler angles in a sequence where the first element
  /// is the X-component
  /// \param kStab The value of the kstabilizer
  ///
  ...
  ///
  Rotation toMatrix(bool skipAsserts = false) const;
  ...
  ///
  Quaternion timeStep(const Vector3d& omega, const Scalar& dt);
  ...
  ///
  Quaternion omegaToQuatDot(const Vector3d& omega) const;

  ///
  /// \brief Generate the velocity matrix which allows to go from/to euler
  /// angles to/from omega(body velocity)
  /// \param euler the Euler angles
  /// \param seq the Euler angles sequence
  /// \return a 3d matrix
  ///
  Matrix3d velocityMatrix(const Vector3d& euler, const String& seq);
  ...
  ///
  /// \brief converts a 3d vector of the body angular velocity (omega) into a 3d
  /// vector of the euler angles rate.
  /// \param euler the Euler angles
  ...
  ///
  Vector3d
  omegaToEulerDot(const Vector3d& euler, const Vector3d& w, const String& seq);

  ///
  /// \brief Return the time derivative of the quaterion
  /// \param w The vector of time derivative (output)
  ///
  void derivate(const Vector& w);
