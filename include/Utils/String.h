...
#endif
{
 public:
  ...
  ///
  String operator()(size_t startIdx, size_t lastIdx) const;
  ...
  ///
  /// \brief Overload of the to_string C++11 function to allow for X-digits
  /// precision
  ...
  ///
  static String removeTrailing(const String& origin, const String& trailTag);
};
...
std::ostream& operator<<(
    std::ostream& os,
    const BIORBD_NAMESPACE::utils::String& a);
#endif
