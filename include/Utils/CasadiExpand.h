...
///
casadi::MX lt(const casadi::MX& x, const casadi::MX& y);
...
/// \return The lesser than element
///
casadi::MX le(const casadi::MX& x, const casadi::MX& y);
...
///
casadi::MX gt(const casadi::MX& x, const casadi::MX& y);
...
/// \return The greater than element
///
casadi::MX ge(const casadi::MX& x, const casadi::MX& y);

///
/// \brief A non-branching and continuous if_else based on tanh. This is not
/// strictly equal to if_else when the values are near each other. The b
/// parameter can be adjusted to increase the rate of change
...
///
/// \brief A non-branching and continuous if_else_zero based on tanh. This is
/// not strictly equal to if_else_zero when the values are near each other. The
/// b parameter can be adjusted to increase the rate of change
/// \param cond The condition (lt/le/gt/ge)
/// \param if_true The value to return if true
/// \param if_false The value to return if false
/// \param b The slope parameter
