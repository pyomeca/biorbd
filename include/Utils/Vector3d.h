...
#endif
{
 public:
  ...
  /// \param parentName Name of the parent segment
  ///
  Vector3d(const Vector3d vec, const String& name, const String& parentName);

  ///
  /// \brief Construct a 3D vector from a Casadi 3D vector (drop the trailling
  /// 1)
  ...
  ///
  /// \brief Construct a 3D vector from a Casadi ND vector (drop the trailling
  /// 1)
  ...
  ///
  /// \brief Construct a 3D vector from an eigen 4D vector (drop the trailling
  /// 1)
  ...
  /// \param other The Casadi ND vector
  ///
  Vector3d(const RBDLCasadiMath::MX_Xd_SubMatrix& other);
#endif
  ...
  //
  Vector3d applyRT(const RotoTrans& rt) const;
  ...
  ///
  /// \brief Construct a 3D vector from a Casadi 4D vector (drop the trailling
  /// 1)
  /// \param other The Casadi 4D vector
  ///
  template <unsigned int i, unsigned int j>
  void operator=(const MX_Xd_static<i, j>& other) {
  ...
  ///
  void operator=(const RigidBodyDynamics::Math::Vector4d& other);
