...
#endif
{
 public:
  ...
  Matrix2d(const Eigen::MatrixBase<OtherDerived>& other)
  ...
  ///
  Matrix2d(const RBDLCasadiMath::MX_Xd_static<2, 2>& other);

  ///
  /// \brief Construct matrix from Casadi matrix
  /// \param other The matrix to copy
  ///
  Matrix2d(const RBDLCasadiMath::MX_Xd_SubMatrix& other);
  ...
  /// \param other The matrix to copy
  ///
  void operator=(const RBDLCasadiMath::MX_Xd_static<2, 2>& other);
