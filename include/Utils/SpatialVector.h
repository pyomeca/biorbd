...
#endif
{
 public:
  ...
  ///
  SpatialVector(const Vector3d& moment, const Vector3d& force);
  ...
  /// \param other The SpatialVector to copy
  ///
  SpatialVector(const RigidBodyDynamics::Math::SpatialVector& other);
#endif
  ...
  ///
  SpatialVector(const casadi::MX& v);

  ///
  /// \brief Construct SpatialVector from Casadi matrix
  /// \param other The SpatialVector to copy
  ///
  SpatialVector(const RBDLCasadiMath::MX_Xd_SubMatrix& m);
#endif
  ...
  /// \param other The SpatialVector to copy
  ///
  void operator=(const SpatialVector& other);
