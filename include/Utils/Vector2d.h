...
#endif
{
 public:
  ...
  /// \param parentName Name of the parent segment
  ///
  Vector2d(const Vector2d vec, const String& name, const String& parentName);

  ///
  /// \brief Construct a 2D vector from a Casadi 2D vector (drop the trailling
  /// 1)
  /// \param other The Casadi 2D vector
  ///
  Vector2d(const RigidBodyDynamics::Math::Vector2d& other);

  ///
  /// \brief Construct a 2D vector from a Casadi ND vector (drop the trailling
  /// 1)
  /// \param other The Casadi ND vector
  ///
  Vector2d(const RigidBodyDynamics::Math::VectorNd& other);
  ...
  /// \param other The Casadi ND vector
  ///
  Vector2d(const RBDLCasadiMath::MX_Xd_SubMatrix& other);
#endif
  ...
  ///
  /// \brief Construct a 2D vector from a Casadi 4D vector (drop the trailling
  /// 1)
