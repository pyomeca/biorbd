...
{
    public:
        s2mMuscleStateDynamics(const double &e = 0, const double &a = 0);
        ...
        virtual double timeDerivativeActivation(double excitation, double activation, const s2mMuscleCaracteristics& caract, const bool alreadyNormalized = false); // Fonction de calcul de la vitesse d'activation en fonction de l'excitation et de l'activation
        virtual double timeDerivativeActivation(const s2mMuscleStateDynamics& state, const s2mMuscleCaracteristics& caract, const bool alreadyNormalized = false); // Fonction de calcul de la vitesse d'activation en fonction de l'excitation et de l'activation
