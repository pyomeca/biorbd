...
class BIORBD_API s2mMarkers
{
    public:
        ...
        void coucou  (s2mJoints&);
        void coucou  (const s2mGenCoord&);
        void coucou  (s2mJoints&, const s2mGenCoord&);
        void coucou2  (const s2mGenCoord&);
        void coucou3  (s2mJoints&, const s2mGenCoord&);
    protected:
