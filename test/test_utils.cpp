...
TEST(Quaternion, multiplication)
{
    ...
    EXPECT_NEAR(q1f[3], 5, requiredPrecision);
    EXPECT_NEAR(q1f[0], 10, requiredPrecision);
    EXPECT_NEAR(q1f[1], 15, requiredPrecision);
    EXPECT_NEAR(q1f[2], 20, requiredPrecision);
}
