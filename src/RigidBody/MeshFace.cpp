...
void rigidbody::MeshFace::DeepCopy(const rigidbody::MeshFace
        &other)
{
    *m_face = *other.m_face;
}
...
std::vector<int> rigidbody::MeshFace::face()
{
    return *m_face;
}
...
void rigidbody::MeshFace::setFace(const rigidbody::MeshFace
        &other)
{
    m_face = other.m_face;
}
