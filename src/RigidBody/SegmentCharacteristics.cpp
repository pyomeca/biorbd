...
rigidbody::SegmentCharacteristics rigidbody::SegmentCharacteristics::DeepCopy()
    const {
...
void rigidbody::SegmentCharacteristics::setLength(const utils::Scalar &val) {
  *m_length = val;
}
...
void rigidbody::SegmentCharacteristics::setMass(const utils::Scalar &newMass) {
  mMass = newMass;
}

utils::Scalar rigidbody::SegmentCharacteristics::mass() const { return mMass; }

utils::Vector3d rigidbody::SegmentCharacteristics::CoM() const {
  return mCenterOfMass;
}

void rigidbody::SegmentCharacteristics::setCoM(const utils::Vector3d &com) {
  mCenterOfMass = com;
}

rigidbody::Mesh &rigidbody::SegmentCharacteristics::mesh() { return *m_mesh; }

const rigidbody::Mesh &rigidbody::SegmentCharacteristics::mesh() const {
  return *m_mesh;
}
