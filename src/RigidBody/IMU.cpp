...
rigidbody::IMU::IMU(bool isTechnical, bool isAnatomical)
    : utils::RotoTransNode(),
...
rigidbody::IMU::IMU(const rigidbody::IMU &imu)
...
rigidbody::IMU rigidbody::IMU::operator*(const rigidbody::IMU &other) const {
...
bool rigidbody::IMU::isAnatomical() const { return *m_anatomical; }

bool rigidbody::IMU::isTechnical() const { return *m_technical; }
