...
internal_forces::passive_torques::PassiveTorque::PassiveTorque(
    const std::shared_ptr<internal_forces::passive_torques::PassiveTorque> other) :
    m_type(other->m_type),
    m_jointName(other->m_jointName),
    m_dofIdx(other->m_dofIdx)
{
...
internal_forces::passive_torques::TORQUE_TYPE internal_forces::passive_torques::PassiveTorque::type() const
{
    return *m_type;
}
