...
internal_forces::passive_torques::PassiveTorqueLinear::DeepCopy() const {
  internal_forces::passive_torques::PassiveTorqueLinear copy;
  copy.DeepCopy(*this);
  return copy;
}

void internal_forces::passive_torques::PassiveTorqueLinear::DeepCopy(
    const internal_forces::passive_torques::PassiveTorqueLinear& other) {
...
utils::Scalar
internal_forces::passive_torques::PassiveTorqueLinear::passiveTorque() {
  utils::Error::raise(
      "passiveTorque for PassiveTorqueLinear must be called with Q");
}
