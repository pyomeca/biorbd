...
internal_forces::passive_torques::PassiveTorqueExponential
internal_forces::passive_torques::PassiveTorqueExponential::DeepCopy() const {
  internal_forces::passive_torques::PassiveTorqueExponential copy;
  copy.DeepCopy(*this);
  return copy;
}

void internal_forces::passive_torques::PassiveTorqueExponential::DeepCopy(
    const internal_forces::passive_torques::PassiveTorqueExponential& other) {
...
utils::Scalar
internal_forces::passive_torques::PassiveTorqueExponential::passiveTorque() {
  utils::Error::raise(
      "passiveTorque for PassiveTorqueExponential must be called with Q");
}
...
internal_forces::passive_torques::PassiveTorqueExponential::passiveTorque(
  ...
  return (*m_b1 * exp(*m_k1 * (Q[dofIdx] - *m_qMid)) +
          *m_b2 * exp(*m_k2 * (Q[dofIdx] - *m_qMid))) *
             (1 - *m_pBeta * (Qdot[dofIdx] / (*m_sV * *m_wMax))) *
             (Q[dofIdx] - *m_deltaP) +
         *m_tauEq;
}
