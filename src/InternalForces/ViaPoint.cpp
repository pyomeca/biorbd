...
internal_forces::ViaPoint::ViaPoint() : utils::Vector3d() {
...
internal_forces::ViaPoint::ViaPoint(const utils::Vector3d& other)
...
void internal_forces::ViaPoint::DeepCopy(
    const internal_forces::ViaPoint& other) {
