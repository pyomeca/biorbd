...
void internal_forces::WrappingSphere::DeepCopy(
    const internal_forces::WrappingSphere& other) {
...
void internal_forces::WrappingSphere::setDiameter(const utils::Scalar& val) {
  *m_dia = val;
}
