...
internal_forces::ligaments::LigamentSpringLinear::LigamentSpringLinear(
  ...
  const std::shared_ptr<internal_forces::ligaments::LigamentSpringLinear>
      ligament_tp(
          std::dynamic_pointer_cast<
              internal_forces::ligaments::LigamentSpringLinear>(other));
  utils::Error::check(
      ligament_tp != nullptr, "ligament must be of a spring linear Type");
...
const utils::Scalar &
internal_forces::ligaments::LigamentSpringLinear::stiffness() const {
  return *m_stiffness;
}
...
internal_forces::ligaments::LigamentSpringLinear::LigamentSpringLinear(
  ...
  const internal_forces::ligaments::LigamentSpringLinear &ligament_tp(
      dynamic_cast<const internal_forces::ligaments::LigamentSpringLinear &>(
          other));
  m_stiffness = ligament_tp.m_stiffness;
}
