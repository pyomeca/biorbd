...
const utils::Scalar &
internal_forces::ligaments::LigamentSpringSecondOrder::stiffness() const {
  return *m_stiffness;
}
...
const utils::Scalar &
internal_forces::ligaments::LigamentSpringSecondOrder::epsilon() const {
  return *m_epsilon;
}
...
internal_forces::ligaments::LigamentSpringSecondOrder::
    LigamentSpringSecondOrder(const internal_forces::ligaments::Ligament &other)
    : internal_forces::ligaments::Ligament(other) {
  const internal_forces::ligaments::LigamentSpringSecondOrder &ligament_tp(
      dynamic_cast<const internal_forces::ligaments::LigamentSpringSecondOrder
                       &>(other));
...
internal_forces::ligaments::LigamentSpringSecondOrder::
    ...
    : internal_forces::ligaments::Ligament(other) {
  const std::shared_ptr<internal_forces::ligaments::LigamentSpringSecondOrder>
      ligament_tp(
          std::dynamic_pointer_cast<
              internal_forces::ligaments::LigamentSpringSecondOrder>(other));
  utils::Error::check(
      ligament_tp != nullptr, "ligament must be of a spring second order Type");
  m_stiffness = ligament_tp->m_stiffness;
  m_epsilon = ligament_tp->m_epsilon;
}
...
void internal_forces::ligaments::LigamentSpringSecondOrder::computeFl() {
  utils::Scalar d =
      position().length() - characteristics().ligamentSlackLength();
