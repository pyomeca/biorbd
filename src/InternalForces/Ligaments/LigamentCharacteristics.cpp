...
internal_forces::ligaments::LigamentCharacteristics::LigamentCharacteristics(
    ...
    : m_ligamentSlackLength(
          std::make_shared<utils::Scalar>(ligamentSlackLength)),
      m_cste_damping(std::make_shared<utils::Scalar>(cste_damping)),
      m_cste_maxShorteningSpeed(
          std::make_shared<utils::Scalar>(cste_maxShorteningSpeed))
...
internal_forces::ligaments::LigamentCharacteristics
internal_forces::ligaments::LigamentCharacteristics::DeepCopy() const {
...
void internal_forces::ligaments::LigamentCharacteristics::
    setLigamentSlackLength(const utils::Scalar& val) {
  *m_ligamentSlackLength = val;
}
const utils::Scalar&
internal_forces::ligaments::LigamentCharacteristics::ligamentSlackLength()
    const {
...
const utils::Scalar&
internal_forces::ligaments::LigamentCharacteristics::maxShorteningSpeed()
    const {
...
const utils::Scalar&
internal_forces::ligaments::LigamentCharacteristics::dampingParam() const {
