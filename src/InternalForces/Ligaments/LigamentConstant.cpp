...
internal_forces::ligaments::LigamentConstant::LigamentConstant(
  ...
  const std::shared_ptr<internal_forces::ligaments::LigamentConstant>
      ligament_tp(
          std::dynamic_pointer_cast<
              internal_forces::ligaments::LigamentConstant>(other));
  utils::Error::check(
      ligament_tp != nullptr, "ligament must be of a constant Type");
...
internal_forces::ligaments::LigamentConstant::LigamentConstant(
  ...
  const internal_forces::ligaments::LigamentConstant &ligament_tp(
      dynamic_cast<const internal_forces::ligaments::LigamentConstant &>(
          other));
  m_force = ligament_tp.m_force;
}
