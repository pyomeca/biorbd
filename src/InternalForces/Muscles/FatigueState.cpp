...
internal_forces::muscles::FatigueState::FatigueState(const internal_forces::muscles::FatigueState
        &other) :
...
internal_forces::muscles::FatigueState::FatigueState(const
        std::shared_ptr<internal_forces::muscles::FatigueState> other) :
    m_activeFibers(other->m_activeFibers),
    m_fatiguedFibers(other->m_fatiguedFibers),
    m_restingFibers(other->m_restingFibers),
    m_type(other->m_type)
...
internal_forces::muscles::FatigueState internal_forces::muscles::FatigueState::DeepCopy() const
{
...
void internal_forces::muscles::FatigueState::DeepCopy(const internal_forces::muscles::FatigueState
        &other)
{
    *m_activeFibers = *other.m_activeFibers;
    *m_fatiguedFibers = *other.m_fatiguedFibers;
...
const utils::Scalar& internal_forces::muscles::FatigueState::activeFibers() const
{
...
internal_forces::muscles::STATE_FATIGUE_TYPE internal_forces::muscles::FatigueState::getType()
const
{
    return *m_type;
}
