...
void internal_forces::muscles::FatigueParameters::DeepCopy(
    const internal_forces::muscles::FatigueParameters& other) {
...
const utils::Scalar&
internal_forces::muscles::FatigueParameters::developFactor() const {
