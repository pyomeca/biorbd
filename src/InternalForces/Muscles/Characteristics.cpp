    ...
    : m_optimalLength(std::make_shared<utils::Scalar>(0)),
      ...
      m_stateMax(
          std::make_shared<internal_forces::muscles::State>(
              internal_forces::muscles::State(1, 1))),
      ...
      m_fatigueParameters(
          std::make_shared<internal_forces::muscles::FatigueParameters>(
...
internal_forces::muscles::Characteristics::Characteristics(
    ...
    : m_optimalLength(std::make_shared<utils::Scalar>(optLength)),
      ...
      m_maxShorteningSpeed(
          std::make_shared<utils::Scalar>(maxShorteningSpeed)) {}

internal_forces::muscles::Characteristics::~Characteristics() {}

internal_forces::muscles::Characteristics
internal_forces::muscles::Characteristics::DeepCopy() const {
...
const utils::Scalar&
internal_forces::muscles::Characteristics::maxShorteningSpeed() const {
...
internal_forces::muscles::Characteristics::stateMax() const {
  return *m_stateMax;
}
...
void internal_forces::muscles::Characteristics::setUseDamping(bool val) {
  *m_useDamping = val;
}
