...
void internal_forces::muscles::FatigueDynamicStateXia::DeepCopy(
    const internal_forces::muscles::FatigueDynamicStateXia& other) {
...
void internal_forces::muscles::FatigueDynamicStateXia::timeDerivativeState(
  ...
  *m_activeFibersDot =
      command -
      characteristics.fatigueParameters().fatigueRate() * *m_activeFibers;
  *m_restingFibersDot =
      -command +
  ...
  *m_fatiguedFibersDot =
  ...
  utils::Error::check(
      fabs(*m_activeFibersDot + *m_restingFibersDot + *m_fatiguedFibersDot) <=
          1e-7,
