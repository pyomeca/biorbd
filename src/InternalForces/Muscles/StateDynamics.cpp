...
{
    const auto& state = dynamic_cast<const internal_forces::muscles::StateDynamics&>(other);
...
internal_forces::muscles::StateDynamics internal_forces::muscles::StateDynamics::DeepCopy() const
{
...
void internal_forces::muscles::StateDynamics::DeepCopy(const
