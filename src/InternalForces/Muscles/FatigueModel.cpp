    ...
    internal_forces::muscles::STATE_FATIGUE_TYPE dynamicFatigueType)
{
    if (dynamicFatigueType ==
        ...
        m_fatigueState = std::make_shared<internal_forces::muscles::FatigueDynamicStateXia>();
    } else {
...
void internal_forces::muscles::FatigueModel::DeepCopy(const internal_forces::muscles::FatigueModel
        &other)
{
...
internal_forces::muscles::FatigueState& internal_forces::muscles::FatigueModel::fatigueState()
{
    ...
    const internal_forces::muscles::StateDynamics &emg)
{
    if (std::dynamic_pointer_cast<internal_forces::muscles::FatigueDynamicState>
            (m_fatigueState)) {
        internal_forces::muscles::Muscle* muscle = dynamic_cast<internal_forces::muscles::Muscle*>(this);
        if (muscle) {
            std::static_pointer_cast<internal_forces::muscles::FatigueDynamicState>
            (m_fatigueState)->timeDerivativeState(emg,
                                                  muscle->characteristics());
        } else {
            utils::Error::raise("internal_forces::muscles::FatigueModel should be a internal_forces::muscles::Muscle");
        }
    } else {
