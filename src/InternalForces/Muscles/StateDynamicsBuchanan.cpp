...
{
    const auto& buchanan =
        dynamic_cast<const internal_forces::muscles::StateDynamicsBuchanan&>(other);
...
{
    // Move excitation to activation to use properly internal_forces::muscles::StateDynamics::timeDerivativeActivation
    ...
    *m_excitationDot = internal_forces::muscles::StateDynamics::timeDerivativeActivation(
