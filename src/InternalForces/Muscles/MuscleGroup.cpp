...
internal_forces::muscles::MuscleGroup::MuscleGroup()
    : m_mus(
          std::make_shared<std::vector<
              std::shared_ptr<internal_forces::muscles::Muscle>>>()),
...
internal_forces::muscles::MuscleGroup
internal_forces::muscles::MuscleGroup::DeepCopy() const {
...
void internal_forces::muscles::MuscleGroup::DeepCopy(
  ...
  for (size_t i = 0; i < other.m_mus->size(); ++i) {
    if ((*other.m_mus)[i]->type() ==
      ...
      (*m_mus)[i] =
          std::make_shared<internal_forces::muscles::IdealizedActuator>(
              (*other.m_mus)[i]);
    } else if (
        (*other.m_mus)[i]->type() ==
        internal_forces::muscles::MUSCLE_TYPE::HILL) {
      (*m_mus)[i] = std::make_shared<internal_forces::muscles::HillType>(
          (*other.m_mus)[i]);
    } else if (
        (*other.m_mus)[i]->type() ==
      ...
      (*m_mus)[i] =
          std::make_shared<internal_forces::muscles::HillDeGrooteType>(
              (*other.m_mus)[i]);
    } else if (
        (*other.m_mus)[i]->type() ==
        internal_forces::muscles::MUSCLE_TYPE::HILL_THELEN_ACTIVE) {
      (*m_mus)[i] =
          std::make_shared<internal_forces::muscles::HillThelenActiveOnlyType>(
              (*other.m_mus)[i]);
    } else if (
        (*other.m_mus)[i]->type() ==
        internal_forces::muscles::MUSCLE_TYPE::HILL_THELEN_FATIGABLE) {
      (*m_mus)[i] =
          std::make_shared<internal_forces::muscles::HillThelenTypeFatigable>(
              (*other.m_mus)[i]);
    } else if (
        (*other.m_mus)[i]->type() ==
        internal_forces::muscles::MUSCLE_TYPE::HILL_DE_GROOTE_ACTIVE) {
      (*m_mus)[i] = std::make_shared<
      ...
      (*m_mus)[i] =
          std::make_shared<internal_forces::muscles::HillDeGrooteTypeFatigable>(
              (*other.m_mus)[i]);
    } else {
      utils::Error::raise(
          "DeepCopy was not prepared to copy " +
          utils::String(
              internal_forces::muscles::MUSCLE_TYPE_toStr(
                  (*other.m_mus)[i]->type())) +
          " type");
    }
  }
...
void internal_forces::muscles::MuscleGroup::addMuscle(
  ...
  if (type == internal_forces::muscles::MUSCLE_TYPE::IDEALIZED_ACTUATOR) {
    muscle = std::make_shared<internal_forces::muscles::IdealizedActuator>(
        name, geometry, characteristics, *state);
    ...
    muscle =
        std::make_shared<internal_forces::muscles::HillThelenTypeFatigable>(
            name, geometry, characteristics, *state, dynamicFatigueType);
  } else if (
      type == internal_forces::muscles::MUSCLE_TYPE::HILL_DE_GROOTE_ACTIVE) {
    muscle =
        std::make_shared<internal_forces::muscles::HillDeGrooteActiveOnlyType>(
            name, geometry, characteristics, *state);
  } else if (
...
void internal_forces::muscles::MuscleGroup::addMuscle(
  ...
  if (type == internal_forces::muscles::MUSCLE_TYPE::IDEALIZED_ACTUATOR) {
    ...
    muscle =
        std::make_shared<internal_forces::muscles::HillThelenTypeFatigable>(
            name, geometry, characteristics, dynamicFatigueType);
  } else if (
      type == internal_forces::muscles::MUSCLE_TYPE::HILL_DE_GROOTE_ACTIVE) {
    muscle =
        std::make_shared<internal_forces::muscles::HillDeGrooteActiveOnlyType>(
...
void internal_forces::muscles::MuscleGroup::addMuscle(
  ...
  if (type == internal_forces::muscles::MUSCLE_TYPE::IDEALIZED_ACTUATOR) {
    ...
    muscle =
        std::make_shared<internal_forces::muscles::HillThelenTypeFatigable>(
            name, geometry, characteristics, pathModifiers, dynamicFatigueType);
  } else if (
      type == internal_forces::muscles::MUSCLE_TYPE::HILL_DE_GROOTE_ACTIVE) {
    muscle =
        std::make_shared<internal_forces::muscles::HillDeGrooteActiveOnlyType>(
...
void internal_forces::muscles::MuscleGroup::addMuscle(
  ...
  if (muscle.type() ==
      internal_forces::muscles::MUSCLE_TYPE::IDEALIZED_ACTUATOR) {
    m_mus->push_back(
        std::make_shared<internal_forces::muscles::IdealizedActuator>(muscle));
  } else if (
      muscle.type() ==
      internal_forces::muscles::MUSCLE_TYPE::HILL_THELEN_FATIGABLE) {
    m_mus->push_back(
    ...
    m_mus->push_back(
      ...
      muscle.type() == internal_forces::muscles::MUSCLE_TYPE::HILL_THELEN) {
    m_mus->push_back(
        std::make_shared<internal_forces::muscles::HillThelenType>(muscle));
  } else if (
      muscle.type() ==
      internal_forces::muscles::MUSCLE_TYPE::HILL_THELEN_ACTIVE) {
    m_mus->push_back(
    ...
    m_mus->push_back(
      ...
      muscle.type() == internal_forces::muscles::MUSCLE_TYPE::HILL_DE_GROOTE) {
    m_mus->push_back(
        std::make_shared<internal_forces::muscles::HillDeGrooteType>(muscle));
  } else if (muscle.type() == internal_forces::muscles::MUSCLE_TYPE::HILL) {
    m_mus->push_back(
        std::make_shared<internal_forces::muscles::HillType>(muscle));
  } else {
...
internal_forces::muscles::Muscle &internal_forces::muscles::MuscleGroup::muscle(
    size_t idx) {
  utils::Error::check(
      idx < nbMuscles(), "Idx asked is higher than number of muscles");
  return *(*m_mus)[idx];
}
const internal_forces::muscles::Muscle &
internal_forces::muscles::MuscleGroup::muscle(size_t idx) const {
  utils::Error::check(
      idx < nbMuscles(), "Idx asked is higher than number of muscles");
  return *(*m_mus)[idx];
}
...
int internal_forces::muscles::MuscleGroup::muscleID(
...
void internal_forces::muscles::MuscleGroup::setOrigin(
    const utils::String &name) {
  *m_originName = name;
}
...
void internal_forces::muscles::MuscleGroup::setInsertion(
    const utils::String &name) {
  *m_insertName = name;
}
