...
biorbd::muscles::StaticOptimizationIpopt::StaticOptimizationIpopt(
        ...
        double eps) :
    m_model(model),
    m_nQ(std::make_shared<unsigned int>(model.nbQ())),
    m_nQdot(std::make_shared<unsigned int>(model.nbQdot())),
    m_nMus(std::make_shared<unsigned int>(model.nbMuscleTotal())),
    m_nDof(std::make_shared<unsigned int>(model.nbDof())),
    m_nGeneralizedTorque(std::make_shared<unsigned int>(model.nbGeneralizedTorque())),
    m_nGeneralizedTorqueResidual(std::make_shared<unsigned int>(*m_nQ)),
