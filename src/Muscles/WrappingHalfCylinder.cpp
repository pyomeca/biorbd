...
muscles::WrappingHalfCylinder::WrappingHalfCylinder(
    ...
    muscles::WrappingObject(other)
{
    muscles::WrappingHalfCylinder& otherWrap(
        const_cast<muscles::WrappingHalfCylinder&>(
            dynamic_cast<const muscles::WrappingHalfCylinder&>(other)));
...
muscles::WrappingHalfCylinder::WrappingHalfCylinder(
    ...
    muscles::WrappingObject (rt.trans()),
...
muscles::WrappingHalfCylinder::WrappingHalfCylinder(
    ...
    muscles::WrappingObject (rt.trans(), name, parentName),
    m_radius(std::make_shared<utils::Scalar>(radius)),
    m_length(std::make_shared<utils::Scalar>(length)),
    m_RTtoParent(std::make_shared<utils::RotoTrans>(rt)),
    m_p1Wrap(std::make_shared<utils::Vector3d>()),
...
muscles::WrappingHalfCylinder
muscles::WrappingHalfCylinder::DeepCopy() const
{
    muscles::WrappingHalfCylinder copy;
    copy.DeepCopy(*this);
    return copy;
}

void muscles::WrappingHalfCylinder::DeepCopy(const
        muscles::WrappingHalfCylinder &other)
{
...
void muscles::WrappingHalfCylinder::setRadius(
    const utils::Scalar &val)
{
    *m_radius = val;
}

utils::Scalar muscles::WrappingHalfCylinder::radius() const
{
    return *m_radius;
}

utils::Scalar muscles::WrappingHalfCylinder::diameter() const
{
    return 2 * *m_radius;
}

void muscles::WrappingHalfCylinder::setLength(
    const utils::Scalar& val)
{
    *m_length = val;
}

const utils::Scalar& muscles::WrappingHalfCylinder::length()
const
{
    return *m_length;
}

void muscles::WrappingHalfCylinder::findTangentToCircle(
...
void muscles::WrappingHalfCylinder::selectTangents(
...
bool muscles::WrappingHalfCylinder::findVerticalNode(
...
bool muscles::WrappingHalfCylinder::checkIfWraps(
    const NodeMusclePair &pointsInGlobal,
    NodeMusclePair &pointsToWrap) const
{
    bool isWrap = 1;
...
utils::Scalar muscles::WrappingHalfCylinder::computeLength(
