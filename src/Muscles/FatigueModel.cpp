...
void biorbd::muscles::FatigueModel::DeepCopy(const biorbd::muscles::FatigueModel &other)
{
...
const biorbd::muscles::FatigueState& biorbd::muscles::FatigueModel::fatigueState() const
{
    return *m_fatigueState;
}

void biorbd::muscles::FatigueModel::computeTimeDerivativeState(const biorbd::muscles::StateDynamics &emg)
{
