...
utils::SpatialVector::SpatialVector(const utils::SpatialVector& other)
...
utils::SpatialVector::SpatialVector(const casadi::MX& v)
    : RigidBodyDynamics::Math::SpatialVector(v) {}

utils::SpatialVector::SpatialVector(const RBDLCasadiMath::MX_Xd_SubMatrix& m)
    : RigidBodyDynamics::Math::SpatialVector(m) {}

#endif

void utils::SpatialVector::operator=(const utils::SpatialVector& other) {
...
void utils::SpatialVector::operator=(const casadi::MX& other) {
  this->RigidBodyDynamics::Math::SpatialVector::operator=(other);
}
