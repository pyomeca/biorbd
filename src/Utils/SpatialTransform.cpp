...
utils::SpatialTransform::SpatialTransform(const utils::SpatialTransform& other)
...
utils::SpatialTransform::SpatialTransform(const utils::RotoTrans& rototrans)
    : RigidBodyDynamics::Math::SpatialTransform(
          rototrans.block<3, 3>(0, 0),
          rototrans.trans()) {}
...
void utils::SpatialTransform::operator=(const utils::SpatialTransform& other) {
...
utils::Vector3d utils::SpatialTransform::translation() const { return this->r; }
