...
utils::RotoTransNode::RotoTransNode() : utils::RotoTrans(), utils::Node() {
  setType();
}
...
utils::RotoTransNode::RotoTransNode(
    ...
    : utils::RotoTrans(rt), utils::Node(name, parentName) {
  setType();
}
...
void utils::RotoTransNode::operator=(const utils::RotoTrans &other) {
...
utils::RotoTransNode utils::operator*(
  ...
  return utils::RotoTransNode(
      other.operator*(me), me.utils::Node::name(), me.parent());
}
