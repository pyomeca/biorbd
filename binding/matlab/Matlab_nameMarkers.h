                         ...
                         int nrhs, const mxArray*prhs[] )
{
    ...
    std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::String> allMarkers(model->markerNames());
                                  ...
                                  int nrhs, const mxArray*prhs[] )
{
    ...
    // Trouver ou sont les marqueurs
    std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::String> allMarkers(model->technicalMarkerNames());
                                   ...
                                   int nrhs, const mxArray*prhs[] )
{
    ...
    // Trouver ou sont les marqueurs
    std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::String> allMarkers(model->anatomicalMarkerNames());
