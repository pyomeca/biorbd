...
void Matlab_muscleJointTorqueFromMuscleForce(
    int,
    mxArray *plhs[],
    int nrhs,
    const mxArray *prhs[]) {
  ...
  checkNombreInputParametres(
      ...
      "3rd is the Q, 4th is QDot, 5th is the muscles force norm vector and "
      "optional "
  ...
  std::vector<Eigen::VectorXd> Fm =
      getParameterMuscleForceNorm(prhs, 4, nMuscleTotal);
