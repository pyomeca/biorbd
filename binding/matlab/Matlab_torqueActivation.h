...
void Matlab_torqueActivation(
  ...
  checkNombreInputParametres(
      ...
      5,
      5,
      "5 or 5 arguments are required where the 2nd is the handler on the "
      "model, 3rd is the Q, 4th is QDot and 5th is GeneralizedTorque");
  ...
  std::vector<BIORBD_NAMESPACE::rigidbody::GeneralizedTorque> act =
      getParameterGeneralizedTorque(prhs, 4, model->nbGeneralizedTorque());
