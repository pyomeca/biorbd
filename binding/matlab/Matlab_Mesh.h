                  ...
                  int nrhs, const mxArray*prhs[] )
{
    ...
    if ( idx==-1) { // Si on a demande tous les segments
        ...
        std::vector<std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::Vector3d>> allMesh(model->meshPoints(Q));
        ...
        std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::Vector3d> Mesh_tp(model->meshPoints(Q,
