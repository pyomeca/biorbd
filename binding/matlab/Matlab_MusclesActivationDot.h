...
void Matlab_MusclesActivationDot(
    int,
    mxArray *plhs[],
    int nrhs,
    const mxArray *prhs[]) {
  ...
  checkNombreInputParametres(
      ...
      "the model, "
      "3rd is the excitation, 4th is the activation and 5th is a bool to "
      "express if "
  ...
  std::vector<std::vector<
      ...
      state = getParameterMuscleState(prhs, 2, 3, model->nbMuscleTotal());
