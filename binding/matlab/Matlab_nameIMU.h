...
void Matlab_nameIMU(int, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
...
void Matlab_nameTechnicalIMU(
  ...
  // Trouver ou sont les marqueurs
  std::vector<BIORBD_NAMESPACE::utils::String> allIMU(
      model->technicalIMUsNames());
