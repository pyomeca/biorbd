                            ...
                            int nrhs, const mxArray*prhs[] )
{
    ...
    biorbd::BIORBD_MATH_NAMESPACE::rigidbody::GeneralizedVelocity QDot = *getParameterQdot(prhs, 3,
            nQdot).begin();
    // Recevoir Qddot
    biorbd::BIORBD_MATH_NAMESPACE::rigidbody::GeneralizedAcceleration QDDot = *getParameterQddot(prhs, 4,
            nQddot).begin();
    ...
    if (i==-1) {
        std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::Vector3d> COMddot = model->CoMddotBySegment(Q,QDot,
                QDDot,true);
        ...
        biorbd::BIORBD_MATH_NAMESPACE::utils::Vector3d COMddot = model->CoMddotBySegment(Q,QDot,QDDot,
