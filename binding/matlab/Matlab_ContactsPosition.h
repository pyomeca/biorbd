                              ...
                              int nrhs, const mxArray*prhs[] )
{
    ...
    std::vector<BIORBD_NAMESPACE::utils::Vector3d> Contact_tp = model->constraintsInGlobal(Q,
            true);
    ...
    // Remplir le output
    std::vector<BIORBD_NAMESPACE::utils::Vector3d>::iterator it=Contact_tp.begin();
