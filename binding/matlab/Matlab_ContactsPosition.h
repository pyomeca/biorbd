                              ...
                              int nrhs, const mxArray*prhs[] )
{
    ...
    std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::Vector3d> Contact_tp = model->constraintsInGlobal(Q,
            true);
    ...
    // Remplir le output
    std::vector<biorbd::BIORBD_MATH_NAMESPACE::utils::Vector3d>::iterator it=Contact_tp.begin();
