...
void Matlab_ProjectPointJacobian(
    int,
    mxArray *plhs[],
    int nrhs,
    const mxArray *prhs[]) {
  ...
  checkNombreInputParametres(
      ...
      "3rd is the Q and 4th are the 3xN markers where N=nMarkers of the model");
  ...
  // ou techniques
  std::vector<BIORBD_NAMESPACE::rigidbody::NodeSegment> markersOverTime =
  ...
  std::vector<BIORBD_NAMESPACE::utils::Matrix> Jac_tp =
      model->projectPointJacobian(Q, markersOverTime, true);
