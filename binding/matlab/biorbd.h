...
void functionHub(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  // Check for proper number of arguments
  if (nrhs < 1) {
    mexErrMsgIdAndTxt(
        "MATLAB:yprime:invalidNumInputs",
  ...
  if (!toLower(cmd).compare("nmimu")) {
    BIORBD_NAMESPACE::utils::Error::warning(
        0,
        "La fonction \"nmimu\" est obsolete. Remplacer par \"nimu\". Elle sera "
        "retirée prochainement");
  ...
  if (!toLower(cmd).compare("namemimu")) {
    BIORBD_NAMESPACE::utils::Error::warning(
        0,
        "La fonction \"namemimu\" est obsolete. Remplacer par \"nameimu\". "
        "Elle sera retirée prochainement");
  ...
  if (!toLower(cmd).compare("nametechnicalmimu")) {
    BIORBD_NAMESPACE::utils::Error::warning(
        0,
        "La fonction \"nametechnicalmimu\" est obsolete. Remplacer par "
        "\"nametechnicalimu\". Elle sera retirée prochainement");
  ...
  if (!toLower(cmd).compare("nameanatomicalmimu")) {
    BIORBD_NAMESPACE::utils::Error::warning(
        0,
        "La fonction \"nameanatomicalmimu\" est obsolete. Remplacer par "
        "\"nameanatomicalimu\". Elle sera retirée prochainement");
  ...
  if (!toLower(cmd).compare("mimu")) {
    BIORBD_NAMESPACE::utils::Error::warning(
        0,
        "La fonction \"mimu\" est obsolete. Remplacer par \"imu\". Elle sera "
        "retirée prochainement");
  ...
  if (!toLower(cmd).compare("mimujacobian")) {
    BIORBD_NAMESPACE::utils::Error::warning(
        0,
        "La fonction \"mimujacobian\" est obsolete. Remplacer par "
        "\"imujacobian\". Elle sera retirée prochainement");
