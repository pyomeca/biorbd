...
void Matlab_inverseKinematics(
  ...
  checkNombreInputParametres(
      ...
      "the model, 3rd is the 3xNxTime marker positions matrix and 4th is the "
      "initial guess for Q and 5th if you want to remove axes as specified in "
      "the model file [default = true]");
