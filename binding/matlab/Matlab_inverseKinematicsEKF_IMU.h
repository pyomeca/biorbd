                       ...
                       int nrhs, const mxArray*prhs[] )
{
    ...
    try {
        plhs[0] = convertPtr2Mat<biorbd::BIORBD_MATH_NAMESPACE::rigidbody::KalmanReconsIMU>
                  (new biorbd::BIORBD_MATH_NAMESPACE::rigidbody::KalmanReconsIMU(*model, kParams));
    } catch (std::string m) {
                       ...
                       int nrhs, const mxArray*prhs[] )
{
    ...
    destroyObject<biorbd::BIORBD_MATH_NAMESPACE::rigidbody::KalmanReconsIMU>(prhs[1]);
        ...
        int nrhs, const mxArray*prhs[] )
{
    ...
    // Recevoir le kalman
    biorbd::BIORBD_MATH_NAMESPACE::rigidbody::KalmanReconsIMU * kalman =
        convertMat2Ptr<biorbd::BIORBD_MATH_NAMESPACE::rigidbody::KalmanReconsIMU>(prhs[2]);

    // Recevoir la matrice des markers (Ne traite que le premier frame)
    std::vector<std::vector<biorbd::BIORBD_MATH_NAMESPACE::rigidbody::IMU>> imusOverTime =
                getParameterAllIMUs(prhs,3);
    std::vector<biorbd::BIORBD_MATH_NAMESPACE::rigidbody::IMU> imus = imusOverTime[0];
        ...
        int nrhs, const mxArray*prhs[] )
{
    ...
    // Créer un filtre de Kalman
    biorbd::BIORBD_MATH_NAMESPACE::rigidbody::KalmanReconsIMU kalman(*model,
