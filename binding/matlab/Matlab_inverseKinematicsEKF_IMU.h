...
void Matlab_inverseKinematicsEKF_IMUstep( int , mxArray *plhs[],
    ...
    std::vector<std::vector<biorbd::utils::RotoTrans>> imusOverTime = getParameterAllIMUs(prhs,3);
    std::vector<biorbd::utils::RotoTrans> imus = imusOverTime[0];
...
void Matlab_inverseKinematicsEKF_IMUallInOneCall( int, mxArray *plhs[],
    ...
    std::vector<std::vector<biorbd::utils::RotoTrans>> imusOverTime = getParameterAllIMUs(prhs,2);
