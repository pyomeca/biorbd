...
//    biorbd::utils::Tau tau_calcul = m3.muscularJointTorque(m3, state, true, &Q, &QDot);
//    std::cout << "tau :\n" << tau_calcul << std::endl;
//    RigidBodyDynamics::ForwardDynamics(m3, Q, QDot, tau_calcul, QDDot);
//    std::cout << "forward dynamics done" << std::endl;
//    biorbd::utils::Tau tau_inv(m3.nbTau());
//    tau_inv.setZero();
...
//    }
//    //biorbd::utils::Tau tau_inv = m_model.muscularJointTorque(m_model, m_State, true, &m_Q, &m_Qdot);
//    biorbd::utils::Tau tau(m3.nbTau());
...
//    biorbd::Model m;
//    m = biorbd::utils::Read::readModelFile("pyomecaman.bioMod");
