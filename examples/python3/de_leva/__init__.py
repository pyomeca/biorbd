        ...
        self.de_leva_table = {
            "male": {
                "HEAD": InertiaParameters(
                    relative_mass=lambda m, bio: 0.0694 * total_mass,
                    center_of_mass=lambda m, bio: point_on_vector(0.5002, start=m["TOP_HEAD"], end=m["SHOULDER"]),
                    inertia=lambda m, bio: InertiaParameters.gyration_to_inertia(
                ...
                "TRUNK": InertiaParameters(
                    relative_mass=lambda m, bio: 0.4346 * total_mass,
                ...
                "UPPER_ARM": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0271 * total_mass,
                ...
                "LOWER_ARM": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0162 * total_mass,
                ...
                "HAND": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0061 * total_mass,
                ...
                "THIGH": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.1416 * total_mass,
                ...
                "SHANK": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0433 * total_mass,
                ...
                "FOOT": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0137 * total_mass,
            ...
            "female": {
                "HEAD": InertiaParameters(
                    relative_mass=lambda m, bio: 0.0669 * total_mass,
                ...
                "TRUNK": InertiaParameters(
                    relative_mass=lambda m, bio: 0.4257 * total_mass,
                ...
                "UPPER_ARM": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0255 * total_mass,
                ...
                "LOWER_ARM": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0138 * total_mass,
                ...
                "HAND": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0056 * total_mass,
                ...
                "THIGH": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.1478 * total_mass,
                ...
                "SHANK": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0481 * total_mass,
                ...
                "FOOT": InertiaParameters(
                    relative_mass=lambda m, bio: 2 * 0.0129 * total_mass,
