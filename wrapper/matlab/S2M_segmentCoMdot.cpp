...
void S2M_segmentCOMdot( int nlhs, mxArray *plhs[],
	...
	if (i==-1){
		std::vector<RBDM::Vector3d> COMdot = model->CoMdotBySegment(Q,QDot,true);
		...
		RBDM::Vector3d COMdot = model->CoMdotBySegment(Q,QDot,i,true); 
